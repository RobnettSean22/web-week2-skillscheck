...
console.log(iLove('Sean', 'rootbeer'))
//////////////////PROBLEM 8////////////////////
...
var total = myNumbers.reduce(function(total, num){
...
var forTheLoveOfGeorge = notGeorge.map(function(notGeorge){
	return 'George'
...
var enemies = people.filter(function(people){
	return enemies = people.friend === false
})
console.log(enemies)
//////////////////PROBLEM 20////////////////////
...
var awesomeLevel = [10,10,3,6,8,7]
var totallyAwesome = awesomeLevel.reduce(function(totallyAwesome, num){
	return totallyAwesome = totallyAwesome + num
})
