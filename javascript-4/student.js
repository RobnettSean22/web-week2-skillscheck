...
var faveColors = ['purple', 'black', 'white']
...
var me = {
    firstName: 'Sean',
    superHeroName: 'UniverSoul',
    homeTown: 'Denver',
    superPowers: ['Conjuring', 'Spitting Fire', 'Teleporting'],
...
function setColor(arr){
    faveColors = faveColors.splice(2,0, 'blue')
    for(i = 0; i <= faveColors; i++ ){
        

    }
    background('purple', 'black', 'white')
}
...
function redactInfo(obj){
    for(i = 0; i <= obj; i++){
        me[firstName] = 'redacted'
        me[superHeroName] = 'redacted'
        me[homeTown]= 'redacted'
        me[superPowerXP] = 'redacted'
        me[superPowers]= 'redacted'
        me[profileImage]= 'redacted'
    }
    redacted()
}